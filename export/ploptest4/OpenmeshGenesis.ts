export const OpenmeshGenesisContract = {
  address: "0xbf818805e5431772ea6946ED4AEC614c51c37daf",
  abi: [
    {
      type: "constructor",
      inputs: [
        ...
        { name: "_periodEnds", type: "uint32[]", internalType: "uint32[]" },
        { name: "_minWeiPerAccount", type: "uint256", internalType: "uint256" },
        { name: "_maxWeiPerAccount", type: "uint256", internalType: "uint256" },
      ],
